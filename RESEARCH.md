...
> This file informed an earlier BYO-key / consumer-subscription OAuth direction. **Do not implement Claude Pro login, ChatGPT login, or hosted consumer OAuth.**  
> Canonical product is **`PRODUCT_DESIGN.md` (v2)**: hosted sandbox + multi-LLM gateway (our keys, our machines). Acceptance bar: `SPECS/exceptional-bar.md`.
